...
const MyAppointments = () => {
    ...
    const delete_appoint = ({d_name,_id,appoint_date,appoint_time}) => () => {
        swal({
            title: "Are you sure?",
            text: `Are you Sure, you want to cancel your appointment with Dr. ${d_name} on ${appoint_date} ${appoint_time}`,
            icon: "warning",
            buttons: true,
            dangerMode: true,
          })
